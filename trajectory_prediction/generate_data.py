...
if __name__ == "__main__":
    ...
    np.savez('data/train_data.npz', inputs_train=inputs_train, targets_train=targets_train)
    ...
    np.savez('data/val_data.npz', inputs_val=inputs_val, targets_val=targets_val)
    np.savez('data/test_data.npz', inputs_test=inputs_test, targets_test=targets_test)
